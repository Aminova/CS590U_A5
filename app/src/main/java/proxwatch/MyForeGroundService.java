...
// Add the request to the RequestQueue.
    ...
    private void startForegroundService() {
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(this, "proxwatch");

        // Make notification show big text.
        NotificationCompat.BigTextStyle bigTextStyle = new NotificationCompat.BigTextStyle();
        bigTextStyle.setBigContentTitle("Tracking exposure");
        bigTextStyle.bigText("ProxWatch is monitoring your exposure.");
        // Set big text style.
        builder.setStyle(bigTextStyle);
        builder.setContentTitle("ProxWatch is monitoring your exposure.");
...
// start
    ...
    private void createNotificationChannel() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            NotificationChannel channel = new NotificationChannel("proxwatch", "ProxWatch notification", importance);
            channel.setDescription("Proxwatch persistent notification");
